...
'web.bba.concurrent.attempt.counter': ['value', 'timestamp'],
'web.bba.concurrent.popup.continue.counter': ['value', 'timestamp'],
'web.bba.concurrent.popup.back.counter': ['value', 'timestamp'],
'web.helios.request.response_time.millis' : ['service', 'timestamp', 'value'],
...
'web.tmol.backend_error':['error_code', 'error_category', 'error_message'],
...
'web.checkout.re_reserve_error': ['message', 'event_id'],
'web.checkout.re_reserve_success': ['message', 'event_id']
},
...
$.ajax({
type: 'POST',
data: { metrics: JSON.stringify(data) },
url: url,
dataType: 'json',
timeout: 3000
}).error( function(){
...
} else if ( cookiesAvailable() && window.CookieTree ){
